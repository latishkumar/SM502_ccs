...
uint8_t PLC_Product_ID = 234;*///n

//n uint8_t MaxAllowedTimeShift = 30;
//n uint16_t ClockTimeShiftInvalidLim = 600;
...
uint16_t TransformerRatio_CurrentDen = 500;*///n
...
//n uint32_t Active_Demand_Control_Threshold = 11000;
//uint16_t DurationOfAllLongPowerFailes = 1300;//n


extern uint16_t ThrusholdVoltageSagPer ;//7% percent 
extern uint16_t ThrusholdVoltageSwellPer ;

/*uint16_t ThrusholdPowerDemandCloseToContractPower = 9500;*///n
...
//n uint8_t CurrentActiveTariff = 1;


//uint16_t Output_State = 0; //n
uint16_t previous_output_state= 0;
//uint8_t control_state =0; //n
//uint8_t control_mode = 5; //n


//uint32_t ErrorValue = 0; //n
uint16_t ImportActivePowerOverThrStatus = 0; //boolean //n
//uint16_t ExportActivePowerOverThrStatus = 0; //boolean //n
