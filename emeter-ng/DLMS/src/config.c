...
//uint8_t FirmwareVersionStr[]={5,'V','0','0','0','1'};//n
...
//uint8_t MACAddress[]={0,0xB,0,0,0,0,0x22}; //n
...
//const uint8_t DiconnectControl_Type = 1; //n
...
//const uint16_t Load_Profile_Column_Szs[] = {16,18,23,28,33,38,43,48};//n
...
//uint32_t Instantaneous_Energy_Entries_In_Use = 1;//n
//uint32_t Instantaneous_Energy_Entries = 1; //n
//uint32_t Instantaneous_Energy_Capture_Period = 1;//n
//uint8_t Instantaneous_Energy_Sort_Method = 1;//n
...
uint8_t Instantaneous_Values_Sort_Method = 1;*///n
...
const uint8_t Billing_Profile_Sort_Method = 1;*///n
...
/*uint32_t image_first_not_transferred_block_number=124;*///n
//uint8_t image_transfer_enabled = 1;//n
/**
* NOT-TRANSFERED = 0;
* TRANSFERED = 1;

uint8_t image_transferred_blocks_status;*///n
...
uint8_t image_transfer_status;*///n

//uint32_t image_block_size = 64;//let's assume a single image block size is 64 bytes.//n
//uint8_t image_identification[]={6,1,2,3,4,5,6};//n
//uint8_t image_signature []={6,1,2,3,4,5,6};//n
