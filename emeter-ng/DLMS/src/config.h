...
// firmware event
	...
	ITEM_TAG_FORMER_FIRMWARE,
    ITEM_TAG_DATETIME_FRME,
// synchronization event
    ITEM_TAG_EVENT_CODE_SYNE,
    ITEM_TAG_DATETIME_SYNE1,  // former clock
    ITEM_TAG_DATETIME_SYNE2,  // after synchronization
// disconnect control event
    ITEM_TAG_EVENT_CODE_DE,
    ITEM_TAG_STATUS_DE,
    ITEM_TAG_DATETIME_DE,
// Hourly energy Load Profile item Tags
    ITEM_TAG_DATETIME_LP_1,
    ITEM_TAG_ACTIVE_ENERGY_IMPORT_LP_1,
    ITEM_TAG_ACTIVE_ENERGY_EXPORT_LP_1,
    ITEM_TAG_REACTIVE_ENERGY_QI_LP_1,
    ITEM_TAG_REACTIVE_ENERGY_QII_LP_1,
    ITEM_TAG_REACTIVE_ENERGY_QIII_LP_1,
    ITEM_TAG_REACTIVE_ENERGY_QIV_LP_1,
...
#define NO_OF_EVENT_OBJ          19
#define DISCONNECT_START         EVENT_START + NO_OF_EVENT_OBJ
#define NO_OF_DISCONNECT_OBJ     10
...
#define NO_OF_INST_VALUE_OBJ     13
