...
uint8_t  MAX_IRMS = 80;//A/*[M.G] Changed from 50 to 80 */
uint16_t MAX_VRMS = 280; 
uint8_t  MAX_Frequency = 53;
uint32_t MAXActivePowerTripPoint = 11500; //w watt steps 
uint32_t MAXActivePowerExportTripPoint = 1250000; //in 0.01 w steps

//values in percent 
uint16_t ThrusholdVoltageSagPer = 3000;//30% percent 
uint16_t ThrusholdVoltageSwellPer = 1500;//15% percent
uint16_t VoltageThresholdLongPowerFailePer = 5600;//56%


//under voltage and current ranges 
uint8_t MIN_VRMS = 170;
uint8_t MIN_Frequency = 47;

uint16_t ThresholdLongPowerFaile = 115;
uint16_t TimeThresholdLongPowerFaile = 600; //time in second 
...
uint16_t OverVoltageTripDuration    =  1;

uint16_t OverFrequencyTripDuration  =  10;
uint16_t UnderVoltageTripDuration   =  10;
...
uint16_t NumberOfLongPowerFails = 0; //use method to read from EERPOM
